...
export default async function AccountPersonalDetailsPage() {
  ...
  return (
    <main className="mx-auto max-w-[1180px] px-3 py-6 lg:px-4 lg:py-8">
      <section className="rounded-[8px] bg-white p-6 shadow-[0_8px_24px_rgba(20,24,27,0.07)]">
        ...
        <h1 className="mt-2 text-[30px] font-semibold text-[#202020]">Personal details</h1>
        <p className="mt-2 max-w-[760px] text-[14px] leading-[1.6] text-[#57636c]">
          Update the personal details connected to your Piessang account.
        </p>
      </section>
