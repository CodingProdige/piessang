...
function fallbackReply(input, vendorName = "your seller account") {
  ...
  if (query.includes("payout") || query.includes("stripe") || query.includes("wise") || query.includes("bank")) return "Piessang pays sellers out through Wise payout setup in seller settings. Connect your payout profile first, then settlements move from gross sales to fees, refund adjustments, and finally net due.";
