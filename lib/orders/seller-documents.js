...
export function buildSellerDocumentPayload(order, { sellerCode = "", sellerSlug = "", assetBaseUrl = "" } = {}) {
  ...
  return {
    ...
    branding: {
      ...
      peachBadgeUrl: assetBaseUrl ? `${assetBaseUrl}/badges/secured%20by%20peach-colour.png` : "",
    },
    order: {
    ...
    <html>
      ...
      <body>
        ...
        <div class="footer">
          ...
          ${payload.branding?.peachBadgeUrl ? `<img src="${payload.branding.peachBadgeUrl}" alt="Secured by Peach" class="trust-badge" />` : ""}
        </div>
      </body>
    </html>
  `;
